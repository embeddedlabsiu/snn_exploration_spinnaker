...
def test_full(config, queue=None):
    ...
    # At this point we initialize the simulator at this file line 518.
    # We read the configuration and we set it up
    # print ("break point 2")
    # raw_input()
