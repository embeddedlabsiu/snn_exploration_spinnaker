...
class SNN(AbstractSNN):
    ...
    def add_input_layer(self, input_shape):
        ...
        self.sim.set_number_of_neurons_per_core(self.sim.SpikeSourcePoisson, 20) # limit number of neurons per core for input spike source DEFAULT 100 IRAKLIS
    ...
    def simulate(self, **kwargs):
        ...
        if self._poisson_input:
            ...
            spiketrains = []
            spiketrains = list(rates*1000) #It was 500 IRAKLIS
